...
plotting_util.plot_sims_vs_analytical_multigens([1, 3, 5, 6, 8, 10], 400,
                                                ...
                                                f'../data/manatee/random/er_g5_40pct_intervene.txt', #Plotting intervention as the "no intervention" argument to just see those curves
                                                '../data/manatee/random/er_g5_40pct_{0}_intv.txt',
...
# plt.savefig('../data/manatee/random/er_g5_40pct_interventions.png')
# plt.savefig('../data/manatee/random/er_g5_40pct_interventions.svg', fmt='svg')
# plt.savefig('./manatee_single_interv_figure.png')
# plt.savefig('./manatee_single_interv_figure.svg', fmt='svg')
plt.show()
...
pgf_formalism.compute_phase_space(20, 400, er_degree_dist, 0.8, True,
                                  ...
                                  '../data/rollouts/random/er_manatee_11_12_{0}',
...
plotting_util.plot_sims_vs_analytical_multigens([1, 2, 3, 4, 5, 6, 8], 200,
                                                f'../data/rollouts/random/er_g5_intervene.txt', # non-intervention
                                                # Plotting intervention as the "no intervention" argument to just see those curves
                                                '../data/rollouts/random/er_manatee_11_12_{0}_intv.txt',
                                                same_plot=True, normalize_axis_x=False,
...
plt.savefig('../data/manatee/rollouts/346_70pct_interventions.png')
plt.savefig('../data/manatee/rollouts/346_70pct_interventions.svg', fmt='svg')
plt.show()
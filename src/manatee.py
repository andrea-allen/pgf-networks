...
# -*- coding: utf-8 -*-
"""
On defining the most absurd transmission expression ever.
"""
...
def l_of_g_new(g, l, beta_list, gamma_list, q_list, v_list):
    first_term = 1
    for l_prime in range(g,l): #product term
        first_term = first_term *(((1 - v_list[l_prime]) * q_list[l_prime] * beta_list[l_prime]) /
                                  (beta_list[l_prime] + gamma_list[l_prime] + beta_list[l_prime] * q_list[l_prime] * (1 - v_list[l_prime])))
    
    #This is correct
    second_term = ((1 - v_list[l]) * beta_list[l]) / (beta_list[l] + gamma_list[l] + beta_list[l] * q_list[l] * (1 - v_list[l]))
...
def t_of_g(betas, gammas, qs, vaccs, g):
    ...
    for l in range(g + 1, len(betas_extended)): #good to go
        ...
        g_term += l_of_g_new(g, l, betas_extended, gammas_extended,
                         qs_extended,
                         vaccs_extended)

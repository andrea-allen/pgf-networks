...
power_law_dd = degree_distributions.power_law_degree_distrb(size, mu=150)
...
extnct_cake_Bin_1, psi_2 = pgf_formalism.compute_extinct_prob_all(binom_dd, T=0.8, n_gens =11, renorm=True)
extnct_ts_2 = np.sum(extnct_cake_Bin_1, axis=(1,2))

extnct_cake_BiMod_1, psi_3 = pgf_formalism.compute_extinct_prob_all(bi_mod_dd, T=0.8, n_gens =11, renorm=True)
